...
one-version-per-file selection and readers that carry a panel contract; ONS
boundaries, adjacency, Census 2021 population, deprivation deciles, the
balanced area-by-month panel and the coverage audit. Treatment definitions and
estimators (M3 and M4) and reporting (M5) follow.
