...
#>   ───────────────  ────────  ──────────  ──────────────  ──────
#>   Treated × after    −0.226      0.0133  [−0.252, −0.2]  <0.001
```
...
#>   ──────────────────  ────────  ──────────  ─────────────────  ──────
#>   -8                   −0.0114      0.0378  [−0.0854, 0.0626]   0.763
#>   -7                   −0.0509       0.057   [−0.163, 0.0608]   0.372
#>   -6                   −0.0425      0.0515   [−0.144, 0.0585]   0.409
#>   -5                   −0.0784      0.0517    [−0.18, 0.0229]   0.129
#>   -4                   −0.0155      0.0534    [−0.12, 0.0892]   0.772
#>   -3                   −0.0542      0.0633   [−0.178, 0.0699]   0.392
#>   -2                   −0.0708      0.0485   [−0.166, 0.0243]   0.145
#>   -1 (reference)             0           0             [0, 0]        
#>   0                     −0.179      0.0582  [−0.293, −0.0647]   0.002
#>   1                     −0.313      0.0563   [−0.423, −0.203]  <0.001
#>   2                      −0.28      0.0569   [−0.392, −0.169]  <0.001
#>   3                     −0.278       0.054   [−0.384, −0.172]  <0.001
#>   4                     −0.253      0.0571   [−0.365, −0.141]  <0.001
#>   5                     −0.259      0.0518   [−0.361, −0.158]  <0.001
#>   6                     −0.234      0.0499   [−0.332, −0.136]  <0.001
#>   7                     −0.221      0.0464    [−0.312, −0.13]  <0.001
#>   8                     −0.251       0.036   [−0.322, −0.181]  <0.001
```
