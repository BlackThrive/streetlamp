...
1. Run win-builder on devel and release, and rhub, then record the results
   in `cran-comments.md` and delete the comment at the top of it. These are
   the only checks that have not run.
