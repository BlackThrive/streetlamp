...
- Next: re-run win-builder on this tree, since the package now has three new exports and two new Imports that the earlier runs never saw, then the maintainer submits.
