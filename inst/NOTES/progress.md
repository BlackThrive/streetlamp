...
- Next: the maintainer creates `github.com/Mustapha-Wasseja/streetlamp` and pushes, publishes the pkgdown site, then rhub and win-builder. Nothing else is outstanding.
